...
class CallGraph:
    ...
    def add_function(self, function_id: int, file_index: int, start_line: int, start_column: int, end_line: int,
                     end_column: int):
        self.functions[function_id] = Function(self.files[file_index], start_line, start_column, end_line,
                                               end_column)

    def add_call(self, call_id: int, file_index: int, start_line: int, start_column: int, end_line: int,
                 end_column: int):
    ...
    def find_function_entity(self, function_info):
        ...
        for function_id, function in self.functions.items():
            if function.file == file and function.start_line == start_line and function.start_column == start_column \
                    and function.end_line == end_line and function.end_column == end_column:
                return function
        return None

    def get_callee(self, file: str, start_line: int, start_column: int, end_line: int,
                   end_column: int) -> Function | None:
