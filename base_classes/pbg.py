...
class PBG:
    ...
    def __init__(self, cpg: CPG, pdg_dict: dict[int, PDG], package_dir, package_name):
        self.entrance_node = None  # the entrance of pbg
        self.return_node: list[PDGNode] = []  # the return value of pbg
        ...
        self.pdg_object_data_edge: dict[int, set[Object]] = {}  # data flow from pdg to object
        self.object_pdg_data_edge: dict[Object, set[int]] = {}  # data flow from object to pdg
        self.cpg = cpg
    ...
    def extract_sensitive_subgraph(self, code_info: CodeInfo):
        ...
        for u in sensitive_nodes:
            # find the latest sensitive nodes
