...
class HGTConv(MessagePassing):
    ...
    def __init__(self, in_dim, out_dim, num_types, num_relations, n_heads, dropout=0.2, id2meta=None, use_norm=True,
                 **kwargs):
...
class GeneralConv(nn.Module):
    def __init__(self, conv_name, in_hid, out_hid, num_types, num_relations, n_heads, dropout, id2meta=None,
                 use_norm=True):
        super(GeneralConv, self).__init__()
        self.conv_name = conv_name
        if self.conv_name == 'hgt':
            self.base_conv = HGTConv(in_hid, out_hid, num_types, num_relations, n_heads, dropout, id2meta, use_norm)
